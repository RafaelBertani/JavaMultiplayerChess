...
public class LoginPanel {
    ...
    public LoginPanel(){
        ...
        //title
        ScreenFunctions.label_setup(title, "Login", false, WIDTH/4, 3*HEIGHT/20, WIDTH/2, HEIGHT/10, panel);
        ...
        //label password
        ScreenFunctions.label_setup(passwordLabel, "Digite sua senha:", false, WIDTH/4, 15*HEIGHT/40, WIDTH/5, HEIGHT/20, panel);
        ...
        ScreenFunctions.button_setup(login, "Login", 5*WIDTH/10, 22*HEIGHT/40, 4*WIDTH/20, HEIGHT/20, Screen.myActionListener, panel);
